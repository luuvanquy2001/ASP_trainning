<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bai3.aspx.cs" MasterPageFile="~/Page.Master" Inherits="lab4.bai3" %>
<asp:Content ID="bai3" runat="server" ContentPlaceHolderID ="head"></asp:Content>
<asp:Content ID="bai31" runat="server" ContentPlaceHolderID ="ContentPlaceHolder1">
        <div>
        <table style="width:50%">
    <tr>
        <td colspan="3">
            <div class="row-1-col-1">ĐĂNG KÝ THÔNG TIN CÁ NHÂN CỦA SINH VIÊN</div>
        </td>
    </tr>
    <tr>
