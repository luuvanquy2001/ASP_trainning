<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="MonHoc.aspx.cs" Inherits="lab5.MonHoc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div>DANH SÁCH TẤT CẢ CÁC MÔN HỌC</div>
     <div>
         Mã môn học:
